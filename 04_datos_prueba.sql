...
-- 1. CARGAR PROFESORES
-- =============================================
CALL SP_CargarProfesor('20123456', 'Juan', 'Pérez', 'Matemáticas', 'juan.perez@universidad.edu', '1122334455');
CALL SP_CargarProfesor('20234567', 'María', 'González', 'Física', 'maria.gonzalez@universidad.edu', '1122334456');
CALL SP_CargarProfesor('20345678', 'Carlos', 'Rodríguez', 'Programación', 'carlos.rodriguez@universidad.edu', '1122334457');
CALL SP_CargarProfesor('20456789', 'Ana', 'Martínez', 'Base de Datos', 'ana.martinez@universidad.edu', '1122334458');
CALL SP_CargarProfesor('20567890', 'Luis', 'Fernández', 'Redes', 'luis.fernandez@universidad.edu', '1122334459');
...
-- =============================================
CALL SP_CargarEstudiante('30111111', 'Pedro', 'Gómez', '2000-05-15', 'pedro.gomez@mail.com', '1155667788', 2024);
CALL SP_CargarEstudiante('30222222', 'Laura', 'López', '2001-08-20', 'laura.lopez@mail.com', '1155667789', 2024);
CALL SP_CargarEstudiante('30333333', 'Diego', 'Sánchez', '2000-11-10', 'diego.sanchez@mail.com', '1155667790', 2024);
CALL SP_CargarEstudiante('30444444', 'Sofía', 'Ramírez', '2001-02-28', 'sofia.ramirez@mail.com', '1155667791', 2024);
CALL SP_CargarEstudiante('30555555', 'Martín', 'Torres', '2000-07-05', 'martin.torres@mail.com', '1155667792', 2024);
...
CALL SP_CargarEstudiante('30888888', 'Camila', 'Díaz', '2001-04-18', 'camila.diaz@mail.com', '1155667795', 2024);
CALL SP_CargarEstudiante('30999999', 'Nicolás', 'Moreno', '2000-06-22', 'nicolas.moreno@mail.com', '1155667796', 2024);
CALL SP_CargarEstudiante('31000000', 'Lucía', 'Herrera', '2001-10-08', 'lucia.herrera@mail.com', '1155667797', 2024);

-- =============================================
-- 5. CARGAR CURSOS
-- =============================================
-- Cursos del primer cuatrimestre 2024
CALL SP_CargarCurso(1, 1, 1, 35, 'Lunes y Miércoles 18:00-20:00');
CALL SP_CargarCurso(2, 1, 1, 35, 'Martes y Jueves 18:00-20:00');
CALL SP_CargarCurso(3, 3, 1, 35, 'Lunes y Miércoles 20:00-22:00');
CALL SP_CargarCurso(4, 4, 1, 35, 'Martes y Jueves 20:00-22:00');

-- Cursos del segundo cuatrimestre 2024
CALL SP_CargarCurso(5, 2, 2, 35, 'Lunes y Miércoles 18:00-20:00');
...
CALL SP_CargarCurso(3, 3, 3, 35, 'Lunes y Miércoles 18:00-20:00');
...
-- Total: 5 profesores, 6 materias, 10 estudiantes, 3 cuatrimestres, 9 cursos, 3 tasas de interés.
